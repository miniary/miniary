...
<jsp:include page="/WEB-INF/views/template/header2.jsp">
	<jsp:param value="비밀번호 수정" name="title"/>
</jsp:include>
...
<body>
	<div>
		<div class="container-500">
			<div class="row center mt-50 mb-30"><h3>비밀번호 변경</h3></div>
			<div class="row">
				<input name="memPw" class="input" type="password" placeholder="새 비밀번호" required="required">
